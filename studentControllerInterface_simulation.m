classdef studentControllerInterface_simulation < matlab.System
    ...
    methods(Access = protected)
        ...
        function V_servo = stepImpl(obj, t, p_ball, theta)
            ...
            %% LQR
                ...
                while iter < max_iter
                    iter = iter + 1;
                    P_next = Q + A_star'*P*A_star - A_star'*P*B_star / (R + B_star'*P*B_star) * B_star'*P*A_star;
                ...
                K_lqr = (R + B_star'*P*B_star) \ (B_star'*P*A_star);
